...
/**
 * Base test class for plugin testing that automatically configures the plugin version property
 * in gradle.properties before each test.
 */
@GradlePluginTests
class AbstractTestingPluginTest {
