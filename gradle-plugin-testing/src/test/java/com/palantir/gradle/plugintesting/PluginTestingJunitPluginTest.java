...
class PluginTestingJunitPluginTest {
    ...
    void correct_versions_from_extension_are_used_by_junit_library(
        ...
        rootProject
                .buildDir()
                .file("gradle-plugin-testing/TestClass/Gradle 7.6.5/testMethod/gradle-version")
                .assertThat()
                .hasContent("7.6.5");

        rootProject
                .buildDir()
                .file("gradle-plugin-testing/TestClass/Gradle 8.14.3/testMethod/gradle-version")
                .assertThat()
                .hasContent("8.14.3");
    }
}
