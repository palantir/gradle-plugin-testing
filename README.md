...
This guide covers how to write tests for Gradle plugins using the `gradle-plugin-testing` framework. Built on Gradle TestKit, this framework provides a modern, Java-based testing approach with JUnit 5 integration, fluent APIs, and automatic multi-version testing across different Gradle releases.
...
See [Resolution of Gradle versions to test against](#resolution-of-gradle-versions-to-test-against) for more details.
