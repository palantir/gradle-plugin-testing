...
public class TestFixtureDecorators {
    public static final class SomeDecorator implements GradleInvokerDecorator<DisabledConfigurationCache> {
    ...
    public @interface WithWrongDecoratorAnnotation {}
}
